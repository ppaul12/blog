...
![](/assets/src/how-to-build-an-assembler/flow_of_compile.png){: width="60%"}
...
![](/assets/src/how-to-build-an-assembler/risc-v_isa.png){: width="60%"}
...
![](/assets/src/how-to-build-an-assembler/assembler_flow.png){: width="80%"}
...
![](/assets/src/how-to-build-an-assembler/assembler_optimize.png){: width="80%"}
