...
![](/assets/src/asm-data-structure/pic3-llist.png){: width="80%"}
...
![](/assets/src/asm-data-structure/pic3-llist-prepend.png){: width="80%"}
...
![](/assets/src/asm-data-structure/pic3-llist-pop.png){: width="80%"}
...
![](/assets/src/asm-data-structure/pic3-res.png){: width="80%"}
