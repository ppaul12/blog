...
{% include embed/image.html src="/assets/src/multi-layer-cache/workflow.png" width="80%" %}
...
{% include embed/image.html src="/assets/src/multi-layer-cache/cache-class.png" width="80%" %}
